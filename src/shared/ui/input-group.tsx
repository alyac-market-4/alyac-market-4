...
function InputGroupInput({ className, ...props }: React.ComponentProps<'input'>) {
  return (
    <Input
      ...
      className={cn(
        'flex-1 rounded-none border-0 bg-transparent shadow-none focus-visible:ring-0 disabled:pointer-events-auto disabled:cursor-not-allowed dark:bg-transparent',
        className,
      )}
      {...props}
    />
