      ...
      <main className="flex-1 overflow-y-auto pb-16">
        ...
        <div className="px-4 py-4">
          <div className="border-border border-b pb-4">
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="bg-muted flex h-12 w-12 items-center justify-center overflow-hidden rounded-full">
                  {/* TODO: 사용자 프로필 사진 alt, src api */}
                  <img
                    alt="이름"
                    className="h-full w-full object-cover"
                    src="https://storage.googleapis.com/alyac-market-server.firebasestorage.app/uploadFiles/1770943665266.png"
                  />
                </div>
                <div className="flex flex-col">
                  {/* TODO: 사용자 이름 api */}
                  <span className="text-foreground font-semibold">이름</span>
                  {/* TODO: 사용자 계정 api */}
                  <span className="text-muted-foreground text-sm">@계정</span>
                </div>
              </div>
              <button
            ...
            {/* TODO: 게시글 내용 api */}
            <p className="text-foreground mb-3 ml-12 text-sm leading-relaxed">안녕하세요</p>
            <div className="mt-3 ml-12 flex gap-4">
              {/* TODO: 게시글 좋아요 onclick api */}
              <button
